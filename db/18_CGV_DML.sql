...
# abc123 회원이 1번 스케쥴(미키 17, 4관 3월 11일 19:20)의 예약 가능한 좌석 A1, A2를 예매했을 때 필요한 쿼리
INSERT INTO TICKET(TI_ADULT, TI_TEEN, TI_PRICE, TI_ME_NUM, TI_SD_NUM)
...
#abc123회원이 2번 스케쥴에 예약했던 좌석 A3, A4 를 취소했을 때 필요한 쿼리
