...
CALL INSERT_PRODUCT("TOP", "셔츠입니다", "셔츠를 싸게 팝니다", 10000, "/IMG/FAN.JPG");
CALL INSERT_PRODUCT("TOP", "반팔", "반팔입니다", 5000, "/IMG/FAN.JPG");
CALL INSERT_PRODUCT("TOP", "구리팬", "아주 비싼 구리팬", 500000, "/IMG/FAN.JPG");

CALL INSERT_PRODUCT("PAN", "반바지", "여름에는 반바지", 30000, "/IMG/FAN.JPG");
CALL INSERT_PRODUCT("PAN", "슬랙스", "무난한 슬랙스", 50000, "/IMG/FAN.JPG");
CALL INSERT_PRODUCT("PAN", "카고바지", "넉넉한 카고바지", 70000, "/IMG/FAN.JPG");

CALL INSERT_PRODUCT("ACC", "결혼반지", "혼수를 위한 반지", 1200000, "/IMG/FAN.JPG");
CALL INSERT_PRODUCT("ACC", "돌반지", "아이를 위한 돌반지", 300000, "/IMG/FAN.JPG");
CALL INSERT_PRODUCT("ACC", "다이아반지", "프로포즈를 위한 반지", 500000, "/IMG/FAN.JPG");

CALL INSERT_PRODUCT("CAP", "벙거지모자", "햇빛을 가릴수도 있어요", 30000, "/IMG/FAN.JPG");
CALL INSERT_PRODUCT("CAP", "군인모자", "군인을 위한 모자", 10000, "/IMG/FAN.JPG");
CALL INSERT_PRODUCT("CAP", "요리사모자", "요리사를 위한 모자", 50000, "/IMG/FAN.JPG");

CALL INSERT_PRODUCT("SHO", "스니커즈", "무난함", 30000, "/IMG/FAN.JPG");
CALL INSERT_PRODUCT("SHO", "운동화", "편안함", 27000, "/IMG/FAN.JPG");
CALL INSERT_PRODUCT("SHO", "구두", "스타일 짱짱", 70000, "/IMG/FAN.JPG");

# abc123회원이 TOP001 제품을 장바구니에 3개 담았을때 쿼리
INSERT CART(CT_AMOUNT, CT_ME_ID, CT_PR_CODE) VALUES(3, "abc123", "TOP001");
# abc123회원이 SHO001 제품을 장바구니에 1개 담았을때 쿼리
...
INSERT INTO BUY(BU_TOTAL_PRICE, BU_ME_ID) VALUES("40000", "abc123");
# 구매 리스트에 장바구니에 담긴 제품들을 추가하는 쿼리
INSERT INTO BUY_LIST(BL_AMOUNT, BL_PRICE, BL_BU_NUM, BL_PR_CODE)
SELECT 3, 10000, MAX(BU_NUM), "TOP001" FROM BUY;
INSERT INTO BUY_LIST(BL_AMOUNT, BL_PRICE, BL_BU_NUM, BL_PR_CODE)
SELECT 3, 30000, MAX(BU_NUM), "SHO001" FROM BUY;
