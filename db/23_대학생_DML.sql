...
# 고길동 (2025160001) 학생이 컴퓨터개론(1), 프로그래밍언어(2), 확률과 통계(5), 음악과 감상(8)을 수강 신청 했을때 쿼리
...
# 프로그래밍 언어(2)의 성적 비율 - 중간 : 40 / 기말 : 40 / 출석 : 10 / 과제 : 10
...
# 고길동(2025160001) 학생의 컴퓨터개론(1) 성적이 중간 100, 기말 100, 과제 80, 출석 100 일때 성적을 계산하는 프로시져
