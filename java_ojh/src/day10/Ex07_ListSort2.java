...
public class Ex07_ListSort2 {
	...
	public static void main(String[] args) {
		...
		list1.add(new Student1(1, 1, 3, "Hong"));
		list1.add(new Student1(1, 1, 1, "Ko"));
		list1.add(new Student1(1, 1, 2, "Kim"));
		...
		list2.add(new Student2(1, 1, 3, "Hong"));
		list2.add(new Student2(1, 1, 1, "Ko"));
		list2.add(new Student2(1, 1, 2, "Kim"));
