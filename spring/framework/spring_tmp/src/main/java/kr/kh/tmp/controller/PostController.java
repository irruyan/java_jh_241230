...
public class PostController {
	...
	public String list(Model model, @PathVariable("po_num") Integer po_num, HttpSession session) {
	...
	public String update(Model model, @PathVariable("po_num") Integer po_num, HttpSession session) {
